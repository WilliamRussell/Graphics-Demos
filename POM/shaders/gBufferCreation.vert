...
{   
	...
	vec3 lookVector = normalize(position.xyz);
	tSpaceLookVector = vec3(dot(lookVector, tangents), dot(lookVector, -binormals), dot(lookVector, normals));	
}